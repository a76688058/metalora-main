...
export default function WorkshopDual() {
    ...
    <div className="h-screen w-full bg-black flex flex-col font-mono text-[#A0A0A0]">
      ...
      <header className="fixed top-0 left-0 right-0 h-[60px] border-b border-white/10 flex items-center px-6 bg-black/80 backdrop-blur-md z-50">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center">
          ...
          <div className="text-[10px] tracking-[0.3em] font-bold text-[#8A2BE2] -mt-1">DUAL_PRODUCTION</div>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center gap-4 pt-[60px]">
        <div className="text-[0.75rem] tracking-[0.5em] text-[#8A2BE2] animate-pulse">INITIALIZING_DUAL_ENGINE...</div>
        <div className="text-[0.6rem] text-white/20 uppercase">Dual comparison mode is under maintenance.</div>
      </main>
    </div>
  );
}
